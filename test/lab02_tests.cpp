...
TEST_F(Lab02Fixture, stringVector_sort_access_test) {
    ...
    container1->append("Apply");
    container1->append("AP");
    container1->append("car");
    container1->append("Apple");
    container1->append("cars");
    container1->append("app");


    container1->sort();


    EXPECT_EQ("app", container1->operator[](0));
    EXPECT_EQ("apple", container1->operator[](1));
    EXPECT_EQ("car", container1->operator[](2));
    EXPECT_EQ("cars", container1->operator[](3));
    EXPECT_EQ("Apple", container1->operator[](4));
    EXPECT_EQ("Apply", container1->operator[](5));
    EXPECT_EQ("AP", container1->operator[](6));
    EXPECT_EQ("Carousel", container1->operator[](7));
}